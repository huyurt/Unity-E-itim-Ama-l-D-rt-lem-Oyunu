<?php
if(isset($_POST['kullaniciSifre']) && isset($_POST['kullaniciSifreTekrar'])) {
    $sifreKontrolu = 0;
    $sifreHataMesaji = NULL;
    $sifre = $_POST["kullaniciSifre"];
    $sifretekrar = $_POST['kullaniciSifreTekrar'];
    ...
    if ($sifre == $sifretekrar) {
        ...
        if (strlen($sifre) < 6) {
            $sifreKontrolu = 1;
            $sifreHataMesaji = "Şifre altı karakterden kısa olamaz.";
        }
    } else {
        $sifreKontrolu = 1;
